...
dataset=read.table("U133p2-R2-MB-series-April13-17.txt", header=T, stringsAsFactors = F)
...
MakeKaplanMeier=function(data, DataSet, LowHighMetod){
  ...
  title(paste("Kaplan-Meier Curves for , ", DataSet, " data\n(", LowHighMetod, ")", sep="")) 
...
pdf("K-M_Curves.UpTo10years.pdf")  
